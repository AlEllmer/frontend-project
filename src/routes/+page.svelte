<script>
	let testimonials = [
		...
		{
			text: 'If you want to lay the best foundation possible, I’d recommend this course. The depth the instructors go into is incredible. I now feel so confident about starting up as a professional developer.',
			name: 'John Tarkpor',
